...
public class MappingValueClassification extends MappingValue {
    ...
    MappingValueClassification(final String targetPath, final List<QName> qualifiedTargetPath, final String value, final String description, final MappingValue.TYPE type, final Integer selectId, final boolean significantForEmptiness, final List<String> keys, final List<String> values) {
